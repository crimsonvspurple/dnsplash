  ...
  <div class="max-w-screen-md px-4 mx-auto">
      ...
      <form name="contact" id="contactForm" class="space-y-8">
          ...
          <div class="mt-6 lg:pb-16">
             <button type="submit" onClick="submitContactForm(event)" class="px-5 py-3 font-bold text-center text-white bg-indigo-600 rounded-lg text-md sm:w-fit hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Send Message</button>
          </div>
      </form>
  </div>
