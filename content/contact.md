  ...
  <div class="max-w-screen-md px-4 mx-auto">
      ...
      <form name="contact" id="contactForm" class="space-y-8">
          ...
          <div class="my-4 sm:col-span-2">
              ...
              <textarea id="contactMessage" name="message" rows="6" class="block p-2.5 w-full text-md text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500" placeholder="Leave a comment..."></textarea>
          </div>
          <div class="mt-6 lg:pb-16">
             <button type="submit" onClick="submitContactForm()" class="px-5 py-3 font-bold text-center text-white bg-indigo-600 rounded-lg text-md sm:w-fit hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Send Message</button>
          </div>
      </form>
  </div>
      <div id="snackbar" class="hidden bg-indigo-900 text-center py-4 lg:px-4 rounded-lg">
        <div class="p-4 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
            <span id="snackbar-message" class="font-semibold text-center flex-auto"></span>
        </div>
    </div>
</section>
